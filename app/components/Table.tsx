...
export default function Table(){
    ...
    return (
        ...
        <div className="flex flex-row gap-x-10 mb-2 mt-2">
            <div className="w-[300px] libre">Name</div>
            <div className="w-[300px] libre">Links</div>
        </div>
        ...
        {contactList.map((contact, index) => (
            ...
            <input
                ...
                className="bg-[#F5EFE7] w-[275px] 2xl:w-[300px]  h-[35px] rounded-md px-2 text-[#213555] libre"
                placeholder="Name"
            />
            <input
                type="text"
