  ...
  return (
    <div className="h-screen flex flex-col relative">
      ...
      <div className="flex-1 bg-[#F5EFE7] flex items-center justify-center relative">
        <div className="absolute top-10 left-20 text-black">Top Left</div>
        <div className="absolute top-10 right-20 text-black">Top Right</div>
        
      </div>

      {/* Bottom Half */}
      <div className="flex-1 bg-[#3E5879] flex items-center justify-center  relative">
        <div className="absolute bottom-10 left-20 text-white">Bottom Left</div>
        <div className="absolute bottom-10 right-20 text-white">Bottom Right</div>
      </div>
    </div>
  </div>
  );
